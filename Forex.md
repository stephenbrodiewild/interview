...
* Run the service locally on port 8080 with `docker run -p 8080:8080 --ulimit nofile=122880:122880 paidyinc/one-frame`
    - Had to modify ulimit to get this working on Arch
